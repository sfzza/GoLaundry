...
class LaundryListPageDry extends StatefulWidget {
  const LaundryListPageDry({Key? key}) : super(key: key);

  @override
  State<LaundryListPageDry> createState() => _LaundryListPageDryState();
}

class _LaundryListPageDryState extends State<LaundryListPageDry> {
