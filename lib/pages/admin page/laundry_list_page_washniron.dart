...
class LaundryListPageWashIron extends StatefulWidget {
  const LaundryListPageWashIron({Key? key}) : super(key: key);

  @override
  State<LaundryListPageWashIron> createState() =>
      _LaundryListPageWashIronState();
}

class _LaundryListPageWashIronState extends State<LaundryListPageWashIron> {
    ...
    return Container(
      ...
      child: StreamBuilder<QuerySnapshot>(
          stream: FirebaseFirestore.instance
              .collection("admins")
              .where("tags", arrayContains: "washniron")
              .snapshots(),
